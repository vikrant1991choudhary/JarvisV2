...
@Entity
@Table(name="MarketHistoryData")

@DynamicInsert
@DynamicUpdate
public class MarketHistoryData implements Serializable{

	@Id
	@Column(name="idMarketHistoryData", nullable=false)
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private Long idMarketHistoryData;
	...
	public Long getIdMarketHistoryData() {
		return idMarketHistoryData;
	}

	public void setIdMarketHistoryData(Long idMarketHistoryData) {
		this.idMarketHistoryData = idMarketHistoryData;
	}
