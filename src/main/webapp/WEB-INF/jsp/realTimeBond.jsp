...
<!-- <script src="/js/jquery.dataTables.min.js"></script> -->
  ...
  $(document).ready(function() {
    ...
    /* $("#bondTypeDiv").change(function() {
    	var drop=($(this).find("option:selected").text());
    	var drop1=($(this).find("option:selected"));
    	alert("bondTypeDiv-"+drop+"drop1-"+drop1);
      ...
      <script>
          $("#helpBtn").click(function(){
            ...
            function getPutData(){
        		...
        		var url = '<%=request.getContextPath()%>/JarvisV2/getRealTimeBond';
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="/JarvisV2/realTimeStock">Stock</a>
						</li>
			...
			<main class="h100">
				<div class="container-fluid position-relative">
					...
					<!--graph section-->
					<div class="row">
					<div class="col-sm-3" id="bondTypeDiv">
							Bond Type <select id="bondType" name="bondType" class="form-control">
													<option value="-1">--Select Bond--</option>
													<option value="Treas">Treasury Bond</option>
													<option value="Zero">Zero Coupan</option>
													<option value="Corp">Corporate Bond</option>	
													<option value="Muni">Municipal Bond</option>	
												</select>
						</div>
						<div class="col-sm-3">
							Bonds LookUp <input type="text" name="bondLookUp" value="" class="form-control"/>
						</div>
